...
fig, axs = plt.subplots(rows, 3, sharex='all', sharey='all', figsize=(12, 7), dpi=100.0)  # 2 rows, 3 columns
...
title_paragraph.font.name = "monospace"  # Change the font to monospace
