...
dynamic_dir = os.path.join(results_dir, 'DynamicAbsolute')
os.makedirs(dynamic_dir, exist_ok=True)
video_name = os.path.join(dynamic_dir, "animation.mp4")
ani.save(video_name, writer='ffmpeg' , dpi = 50)

# Save the animation as an HTML file
html_name = os.path.join(dynamic_dir, "animation.html")
...
video_path = os.path.join(dynamic_dir, "animation.mp4")
slide.shapes.add_movie(video_path, left, top, width, height)

# Save the PowerPoint presentation
pptx_name = os.path.join(dynamic_dir, "dynamics.pptx")
