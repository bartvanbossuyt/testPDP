...
if av.PDPg_fundamental_active == 1:
    filename = os.path.join(report_dir, "report_moving_objects_PDP_fundamental.pdf")
elif av.PDPg_buffer_active == 1:
    filename = os.path.join(report_dir, "report_moving_objects_PDP_buffer.pdf")
elif av.PDPg_rough_active == 1:
    filename = os.path.join(report_dir, "report_moving_objects._PDP_rough.pdf")
elif av.PDPg_bufferrough_active == 1:
    filename = os.path.join(report_dir, "report_moving_objects_PDP_bufferrough.pdf")
else:
...
if av.N_VA_StaticAbsolute == 1:
    ...
    subtitle = Paragraph(subtitle_text, subtitle_style)
    story.append(subtitle)
    file_paths = [os.path.join(results_dir, 'StaticAbsolute', 'N_C_Csa' + str(i) + '.png') for i in range(av.con)]
...
if av.N_VA_StaticRelative == 1:
    ...
    file_paths = [os.path.join(results_dir, 'StaticRelative', 'N_C_Csr' + str(i) + '.png') for i in range(av.con)]
    # Create a list of Image objects from the file paths
    #images = [Image(fp, width=250, height=166) for fp in file_paths]
    images = [Image(fp, width=240, height=240) for fp in file_paths]
    # Split the images list into sublists of 3 images each
...
if av.N_VA_StaticFinetuned == 1:
    ...
    # Create a list of file paths for the images
    #file_paths = [os.path.join(av.dir, 'N_C_Csr' + str(i) + '.png') for i in range(av.con)] 
    file_paths = [os.path.join(results_dir, 'StaticFinetuned', 'N_C_Csf' + str(i) + '.png') for i in range(av.con)]
    # Create a list of Image objects from the file paths
    #images = [Image(fp, width=250, height=166) for fp in file_paths]
...
if av.N_VA_TopK == 1: 
    ...
    if av.PDPg_fundamental_active == 1:
        ...
        file_paths = [os.path.join(results_dir, 'TopK', 'N_C_PDPg_fundamental_TopK_c' + str(i) + '.png') for i in range(av.con)]
        # Create a list of Image objects from the file paths
        images = [Image(fp, width=250, height=166) for fp in file_paths]
    ...
    # PAGE WITH TOPK VISUALISATIONS PDPg_BUFFER
        ...
        story.append(title)
        # Create a list of file paths for the images in the working directory
        file_paths = [os.path.join(results_dir, 'TopK', 'N_C_PDPg_buffer_TopK_c' + str(i) + '.png') for i in range(av.con)]
        # Create a list of Image objects from the file paths
        images = [Image(fp, width=250, height=166) for fp in file_paths]
        # Split the images list into sublists of 5 images each
        image_rows = [images[i:i+3] for i in range(0, len(images), 3)]
    ...
    # PAGE WITH TOPK VISUALISATIONS PDPg_ROUGH
        ...
        story.append(title)
        # Create a list of file paths for the images in the working directory
        file_paths = [os.path.join(results_dir, 'TopK', 'N_C_PDPg_rough_TopK_c' + str(i) + '.png') for i in range(av.con)]
        # Create a list of Image objects from the file paths
        images = [Image(fp, width=250, height=166) for fp in file_paths]
        # Split the images list into sublists of 5 images each
        image_rows = [images[i:i+3] for i in range(0, len(images), 3)]
    ...
    # PAGE WITH TOPK VISUALISATIONS PDPg_BUFFERROUGH
        ...
        story.append(title)
        # Create a list of file paths for the images in the working directory
        file_paths = [os.path.join(results_dir, 'TopK', 'N_C_PDPg_bufferrough_TopK_c' + str(i) + '.png') for i in range(av.con)]
        # Create a list of Image objects from the file paths
        images = [Image(fp, width=250, height=166) for fp in file_paths]
        # Split the images list into sublists of 5 images each
        image_rows = [images[i:i+3] for i in range(0, len(images), 3)]
