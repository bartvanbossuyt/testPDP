"""
Visual Analytics: Creates static relative visualizations
EXPLANATION
    Creates static visualizations with relative scaling based on data range
INPUT
    Dataset from av module
OUTPUT
    PNG images for each configuration (N_C_Csr*.png)
"""
