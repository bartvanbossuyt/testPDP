"""
Visual Analytics: Creates dynamic visualizations with animation
FUNCTIONALITY
    Creates animated visualizations of moving objects
EXPLANATION
    Generates animations showing trajectory movement across configurations
INPUT
    Dataset from av module
OUTPUT
    animation.mp4, animation.html, dynamics.pptx
"""
...
fig, axs = plt.subplots(rows, 3, sharex='all', sharey='all', figsize=(12, 7))
...
title_text = "Animated Visualization"
title_shape = slide.shapes.add_textbox(left, Inches(0.1), width, Inches(0.5))
