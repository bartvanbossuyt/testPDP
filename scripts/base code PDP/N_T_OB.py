...
INPUT PARAMETERS: 
    buffer_x and buffer_y from av module
"""
...
# Get buffer distances from av module
buffer_x = av.buffer_x  # Buffer distance in x-direction
buffer_y = av.buffer_y  # Buffer distance in y-direction
