...
output_folder = os.path.join(av.OUTPUT_FOLDER, 'mds')
os.makedirs(output_folder, exist_ok=True)

# Select filename depending on which PDPg mode is active
if av.PDPg_fundamental_active == 1:
    filename = os.path.join(output_folder, 'N_C_PDPg_fundamental_Mds.png')

elif av.PDPg_buffer_active == 1:
    filename = os.path.join(output_folder, 'N_C_PDPg_buffer_Mds.png')

elif av.PDPg_rough_active == 1:
    filename = os.path.join(output_folder, 'N_C_PDPg_rough_Mds.png')

elif av.PDPg_bufferrough_active == 1:
    filename = os.path.join(output_folder, 'N_C_PDPg_bufferrough_Mds.png')
